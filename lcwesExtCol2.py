...
def filter_fields(input_file, output_file):
    ...
    required_fields = [
        'Chr', 'Start', 'End', 'Ref', 'Alt',  # Matching fields for merging
        'avsnp151', 'Gene.refGene',  # Added new columns
        'Polyphen2_HDIV_pred', 'MutationTaster_pred', 
        'REVEL_score', 'ClinPred_score', 
        'AlphaMissense_pred', 'Aloft_pred',
        'PrimateAI_pred',  # Added PrimateAI
        'BayesDel_addAF_pred',  # Added BayesDel
        'CLNDN',  # Clinical disease name
        'phyloP100way_vertebrate', 'GERP++_RS'  # Conservation scores
    ]
